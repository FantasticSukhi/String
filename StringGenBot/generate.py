...
ask_ques = "**» ▷ ᴄʜᴏᴏꜱᴇ ᴛʜᴇ ꜱᴛʀɪɴɢ ᴡʜɪᴄʜ ᴜ ᴡᴀɴᴛ ✔️ : :**"
buttons_ques = [
    [
...
async def generate_session(bot: Client, msg: Message, telethon=False, old_pyro: bool = False, is_bot: bool = False):
    ...
    if is_bot:
        ty += " ʙᴏᴛ"
    await msg.reply(f"» ᴛʀʏɪɴɢ ᴛᴏ ꜱᴛᴀʀᴛ **{ty}** ꜱᴇꜱꜱɪᴏɴ ɢᴇɴᴇʀᴀᴛᴏʀ...")
    user_id = msg.chat.id
    ...
    if not is_bot:
        t = "» 𝐏𝐋𝐄𝐀𝐒𝐄 𝐒𝐄𝐍𝐃 𝐘𝐎𝐔 **𝐏𝐇𝐎𝐍𝐄 𝐍𝐔𝐌𝐁𝐄𝐑** 𝐖𝐈𝐓𝐇 𝐂𝐎𝐔𝐍𝐓𝐑𝐘 𝐂𝐎𝐃𝐄 𝐅𝐎𝐑 𝐖𝐇𝐈𝐂𝐇 𝐘𝐎𝐔 𝐖𝐀𝐍𝐓 𝐓𝐎 𝐆𝐄𝐍𝐄𝐑𝐀𝐓𝐄 𝐒𝐄𝐒𝐒𝐈𝐎𝐍 \n𝐄𝐗𝐀𝐌𝐏𝐋𝐄 : `+910000000000`'"
    else:
    ...
    text = f"**ᴛʜɪꜱ ɪꜱ ʏᴏᴜʀ {ty} ꜱᴛʀɪɴɢ ꜱᴇꜱꜱɪᴏɴ** \n\n`{string_session}` \n\n**ɢᴇɴᴇʀᴀᴛᴇᴅ ʙʏ :** @MAMBA_HU_VAI\n🍒 **ɴᴏᴛᴇ :** ᴅᴏɴᴛ ꜱʜᴀʀᴇ ᴛʜɪꜱ ᴡɪᴛʜ ᴀɴʏᴏɴᴇ ʙᴇᴄᴀᴜꜱᴇ ʜᴇ ᴄᴀɴ ʜᴀᴄᴋ ʏᴏᴜʀ ᴀʟʟ ᴅᴀᴛᴀ 🍑 ᴀɴᴅ ᴅᴏɴᴛ ꜰᴏʀɢᴇᴛ ᴛᴏ ᴊᴏɪɴ @MAMBA_UPDATES_CHAT & @ 🥺"
    try:
        if not is_bot:
    ...
    await bot.send_message(msg.chat.id, "» ꜱᴜᴄᴄᴇꜱꜱꜰᴜʟʟʏ ɢᴇɴᴇʀᴀᴛᴇᴅ ʏᴏᴜʀ {} ꜱᴛʀɪɴɢ ꜱᴇꜱꜱɪᴏɴ.\n\nᴘʟᴇᴀꜱᴇ ᴄʜᴇᴄᴋ ʏᴏᴜʀ ꜱᴀᴠᴇ ᴍᴇꜱꜱᴀɢᴇ ᴛᴏ ɢᴇᴛ ɪᴛ. ! \n\nᴀ ꜱᴛʀɪɴɢ ɢᴇɴᴇʀᴀᴛᴏʀ ʙᴏᴛ ɪꜱ ᴍᴀᴅᴇ ʙʏ @MAMBA_HU_VAI ♦".format("ᴛᴇʟᴇᴛʜᴏɴ" if telethon else "ᴩʏʀᴏɢʀᴀᴍ"))
...
async def cancelled(msg):
    if "/cancel" in msg.text:
        ...
        await msg.reply("**» ᴄᴀɴᴄᴇʟʟᴇᴅ ᴛʜᴇ ᴏɴɢᴏɪɴɢ ꜱᴛʀɪɴɢ ꜱᴇꜱꜱɪᴏɴ ɢᴇɴᴇʀᴀᴛᴇᴅ ᴘʀᴏᴄᴇꜱꜱ.!**", quote=True)
        return True
    else:
        return False
